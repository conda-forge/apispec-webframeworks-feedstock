...
validate_recipe_outputs "apispec-webframeworks-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="apispec-webframeworks-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi